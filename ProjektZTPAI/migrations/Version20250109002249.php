 ...
 */
final class Version20250109002249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id SERIAL NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, completed BOOLEAN NOT NULL, PRIMARY KEY(id))');
